...
g2 = (0xC6047F9441ED7D6D3045406E95C07CD85C778E4B8CEF3CA7ABAC09B95C709EE5, 0x1AE168FEA63DC339A3C58419466CEAEEF7F632653266D0E1236431A950CFE52A)

g3 = (0xF9308A019258C31049344F85F89D5229B531C845836F99B08601F113BCE036F9, 0x388F7B0F632DE8140FE337E62A37F3566500A99934C2231B6CB9FD7584B8E672)

g4 = (0xE493DBF1C10D80F3581E4904930B1404CC6C13900EE0758474FA94ABE8C4CD13, 0x51ED993EA0D455B75642E2098EA51448D967AE33BFBDFE40CFE97BDC47739922)

g5 = (0x2F8BDE4D1A07209355B4A7250A5C5128E88B84BDDC619AB7CBA8D569B240EFE4, 0xD8AC222636E5E3D6D4DBA9DDA6C9C426F788271BAB0D6840DCA87D3AA6AC62D6)
...
class TestEllipticPointDouble(unittest.TestCase):
	...
	def test_double_1(self):
		...
		self.assertEqual((eGx, eGy), s.point_double(g))
	...
	def test_double_2(self):
		...
		self.assertEqual((eGx, eGy), s.point_double(g2))
	...
	def test_double_3(self):
		...
		self.assertEqual((eGx, eGy), s.point_double(g3))
	...
	def test_double_4(self):
		...
		self.assertEqual((eGx, eGy), s.point_double(g4))
	...
	def test_double_5(self):
		...
		self.assertEqual((eGx, eGy), s.point_double(g5))
