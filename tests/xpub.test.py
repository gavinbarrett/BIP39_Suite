...
class TestPubkeyGenerator(unittest.TestCase):
	...
	def test_pubkey_1(self):
		...
		exp = b'xpub661MyMwAqRbcFtXgS5sYJABqqG9YLmC4Q1Rdap9gSE8NqtwybGhePY2gZ29ESFjqJoCu1Rupje8YtGqsefD265TMg7usUDFdp6W1EGMcet8'
		self.assertTrue(exp, generate_extended_pubkey(secretkey, chaincode))
	...
	def test_pubkey_2(self):
		...
		exp = b'xpub661MyMwAqRbcFW31YEwpkMuc5THy2PSt5bDMsktWQcFF8syAmRUapSCGu8ED9W6oDMSgv6Zz8idoc4a6mr8BDzTJY47LJhkJ8UB7WEGuduB'
		self.assertTrue(exp, generate_extended_pubkey(secretkey, chaincode))
