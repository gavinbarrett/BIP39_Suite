...
if __name__ == "__main__":
	...
	cxpub = pubkey_v + b'\x01' + fingerprint + b'\x80\x00\x00\x00' + child_chain + pub
	print(b58encode_check(cxpub).decode())
	'''
	mnemonics = b'coral jazz noodle also shoot render enter clip spatial arctic current mother'
	x = BIP32_Account(mnemonics, '')
	x.printXPUB()
	'''
